...
class _RecapScreenState extends State<RecapScreen> {
  ...
  Map<String, Map<String, List<ExpenseRowData>>> _groupedRows(
    ...
    final sortedRows = [...rows]..sort((a, b) => b.createdAt.compareTo(a.createdAt));
            ...
            Expanded(
              child: categoryEntries.isEmpty
                ...
                itemBuilder: (context, index) {
                  ...
                  final categoryCount = _categoryOperationCount(subGroups);
                          ...
                          Padding(
                            ...
                            child: Column(
                              children: subEntries.map((subEntry) {
                                ...
                                final subExpanded = _isSubCategoryExpanded(
                                  categoryName,
                                  subCategoryName,
                                );
